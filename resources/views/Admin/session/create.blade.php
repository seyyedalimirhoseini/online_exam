...
@section( 'content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ایجاد فصل</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="#">خانه</a></li>
                        <li class="breadcrumb-item active">ایجاد فصل</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">ایجادفصل</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group  @if ($errors->has('video')) has-error @endif">
                                    ...
                                    <input type="file" class="form-control" name="video" id="video"
                                           placeholder="ویدئو را وارد کنید" value="{{ old('video') }}">
                                ...
                                <label for="time">زمان ویدئو</label>
                                    ...
                                    <div class="input-group @if ($errors->has('time')) has-error @endif">
                                        <input id="timepicker2" placeholder="--:--:-" type="text" value="{{old('time')}}" name="time" class="form-control input-small">
