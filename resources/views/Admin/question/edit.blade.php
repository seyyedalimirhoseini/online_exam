...
@section('title', 'صفحه ویرایش سوال')
@section( 'content')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="post" action="{{route('questions.update',$question->id)}}" role="form">
                            @csrf
                            {{method_field('PATCH')}}
                            <div class="card-body">
                                <div class="form-group @if ($errors->has('question')) has-error @endif">
                                    <label for="question">سوال</label>
                                    <input type="text" max="100" class="form-control" id="question" name="question" value="{{$question->question}}"
                                ...
                                <div class="form-group @if ($errors->has('option1')) has-error @endif">
                                    ...
                                    <input type="text" max="100" class="form-control" id="option1" name="option1" value="{{$question->option1}}"
                                           placeholder="گزینه 1">
                                ...
                                <div class="form-group @if ($errors->has('option2')) has-error @endif">
                                    ...
                                    <input type="text" max="100" class="form-control" id="option2" name="option2" value="{{$question->option2}}"
                                           placeholder="گزینه 2">
                                ...
                                <div class="form-group @if ($errors->has('option3')) has-error @endif">
                                    ...
                                    <input type="text" max="100" class="form-control" id="option3" name="option3" value="{{$question->option3}}"
                                           placeholder="گزینه 3">
                                ...
                                <div class="form-group @if ($errors->has('option4')) has-error @endif">
                                    ...
                                    <input type="text"  max="100" class="form-control" id="option4" name="option4" value="{{$question->option4}}"
                                           placeholder="گزینه 4">
                                ...
                                <div class="form-group @if ($errors->has('answer')) has-error @endif">
                                    ...
                                    <input type="text" max="100" class="form-control" id="answer" name="answer" value="{{$question->answer}}"
                                ...
                                <div class="form-group @if ($errors->has('grade')) has-error @endif">
                                    ...
                                    <input type="text"  class="form-control" id="grade" name="grade" value="{{$question->grade}}"
                                           placeholder="نمره">
                                    <small class="text-danger" id="grade">{{$errors->first('grade')}}</small>
                                </div>
                                <div class="form-group">

                                    <input type="hidden" name="exam_info_id" class="form-control" id="exam_info_id" value="{{$question->exam_info_id}}" >
                                </div>
